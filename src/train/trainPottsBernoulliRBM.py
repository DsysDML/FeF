...
parser = argparse.ArgumentParser(description='Train an RBM with Potts variables in the visible layer and binary variables in the hidden layer.')
...
if args.train_mode == 'new':
    ...
    train_dataset = RBMdataset(args.data, dataset='train')
